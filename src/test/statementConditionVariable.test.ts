import { StatementConditionVariable } from "../lexiconModules/statementConditionVariable";
...
describe("StatementConditionVariable", () => {
  ...
  describe("find", () => {
    it("returns true when conditions are met", () => {
      ...
      document.lineAt = jest.fn().mockReturnValue({ text: "variable =" });
      ...
      const locator = new StatementConditionVariable(
        document,
        position,
        context
      );
